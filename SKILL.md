...
7. 「本轮任务确认单」至少包含：本轮目标、Allowed Files、Forbidden Files / Areas、目标硬件资源或软件模块、关键实现选择、最小可验证目标、最小验证方式、暂不实现的扩展项、硬件风险和需要用户确认的问题。
...
11. 如果项目使用代码生成器（如 CubeMX、MCUXpresso、配置向导），确认修改在用户代码保护区域内；如果需要修改生成区域，提醒用户通过代码生成器操作。
